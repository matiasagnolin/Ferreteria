	...
	public void loaddata() throws Exception{
		try
		{
			...
			vendedor3 = new Vendedor("55555555","pepito","Dummy","11111111","pepito.dummy@gmail.com",
					"19950902","pepito 1735");
			rrhh = new RRHH("6666666","pepito","Dummy","11111111","pepito.dummy@gmail.com",
					"19950902","pepito 1735");
			tipo0 = new Tipos(0,"Cliente");
			tipo1 = new Tipos(1,"Vendedor");
			tipo2 = new Tipos(2,"RRHH");
			usuario1 = new Usuario("cliente1", "123", tipo0,cliente1);
			usuario2 = new Usuario("cliente2", "123",tipo0,cliente2);
			usuario3 = new Usuario("cliente3", "123", tipo0,cliente3);
			usuario4 = new Usuario("vendedor1", "123", tipo1,vendedor1);
			usuario5 = new Usuario("vendedor2", "123", tipo1,vendedor2);
			usuario6 = new Usuario("vendedor3", "123", tipo1,vendedor3);
			usuario7 = new Usuario("RRHH", "123", tipo2,rrhh);
...
//		req=new Request();
//		Comision cliente = new Comision();
//		cliente.setDescripcion("Comision por mejor vendedor");
//		req.setObject(cliente);
//		req.setId(cliente.getDescripcion());
...
//		}
//		serviceBO.setComisionPrimerVendedor(listvendedor);
//		serviceBO.Ordenar(listvendedor);
//		//for(Vendedor vendo : listvendedor) System.out.println(vendo.getComision());
//	}
}
